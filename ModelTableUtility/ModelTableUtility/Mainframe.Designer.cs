...
namespace ModelTableUtility
{
    partial class sMainframe
    {
       ...
       // private string data_source;
        ...
        {
            String strConnection = conn.strconn;
        ...
        private bool Config()
        {
            ...
            try
            {
                config = File.OpenText(conn.FilePath+"ModelTable.ini");
            }
            catch (Exception a)
            {
                MessageBox.Show(a.Message);
            ...
            {
                strConnection = @"Server=(pdi\modeldatabase);Database=modeltables;Trusted_Connection=True;";
            }
            else
            {
              //  media = "server=" + ModTblServer + ";Database=master;uid=sa" + MasterUID + ";pwd=" + ModTblPWD + ";Connect Timeout=1;";
              //  media = "PDI\MODELDATABASE;Initial Catalog=ModelTables;Integrated Security=True";
                  media = "WIN-0HIU6UB5TJ4;Initial Catalog=ModelTables;Integrated Security=True";
                strConnection = @media;
            }
            return true;
        ...
        private int InitializeFile()
        {
            ...
            try
            {
               // ModTbls = File.OpenText("C:\\Program Files\\PASolutions\\Model Tables Utility\\\\ModTbls.cfg");
                ModTbls = File.OpenText(conn.FilePath+"ModTbls.cfg");
            }
            catch (Exception a)
            {
                MessageBox.Show(a.Message);
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(sMainframe));
            ...
            this.printTableOnlyToolStripMenuItem.Size = new System.Drawing.Size(218, 26);
            ...
            this.printEntireScreenToolStripMenuItem.Size = new System.Drawing.Size(218, 26);
            ...
            this.saveDBRecordInFileToolStripMenuItem1.Size = new System.Drawing.Size(272, 26);
            ...
            this.loadDBRecordFromFileToolStripMenuItem.Size = new System.Drawing.Size(272, 26);
            ...
            this.toolStrip1.Size = new System.Drawing.Size(1337, 12);
            ...
            this.tabControl1.Size = new System.Drawing.Size(1305, 660);
            ...
            "true",
            "false"});
            this.cmb_cell.Location = new System.Drawing.Point(165, 811);
            this.cmb_cell.Margin = new System.Windows.Forms.Padding(4, 4, 4, 4);
            this.cmb_cell.Name = "cmb_cell";
            this.cmb_cell.RightToLeft = System.Windows.Forms.RightToLeft.No;
            this.cmb_cell.Size = new System.Drawing.Size(163, 24);
            this.cmb_cell.TabIndex = 6;
            this.cmb_cell.SelectedIndexChanged += new System.EventHandler(this.cmb_cell_SelectedIndexChanged);
            ...
            this.saveToolStripMenuItem1.Size = new System.Drawing.Size(254, 26);
            ...
            this.exitToolStripMenuItem1.Size = new System.Drawing.Size(254, 26);
            ...
            this.printTableOnlyToolStripMenuItem1.Size = new System.Drawing.Size(254, 26);
            ...
            this.saveDBRecordsInFileToolStripMenuItem.Size = new System.Drawing.Size(279, 26);
            ...
            this.loadDBRecordsFromFileToolStripMenuItem.Size = new System.Drawing.Size(279, 26);
            ...
            this.label3.Location = new System.Drawing.Point(892, 812);
            ...
            this.label4.Location = new System.Drawing.Point(1076, 812);
            ...
            this.button7.Location = new System.Drawing.Point(1175, 45);
            ...
            this.button8.Location = new System.Drawing.Point(1030, 45);
            this.button8.Margin = new System.Windows.Forms.Padding(4, 4, 4, 4);
            this.button8.Name = "button8";
            this.button8.Size = new System.Drawing.Size(140, 71);
            ...
            this.button9.Location = new System.Drawing.Point(885, 45);
            this.button9.Margin = new System.Windows.Forms.Padding(4, 4, 4, 4);
            this.button9.Name = "button9";
            this.button9.Size = new System.Drawing.Size(140, 71);
            ...
            this.button4.Location = new System.Drawing.Point(740, 45);
            ...
            this.button5.Location = new System.Drawing.Point(595, 45);
            ...
            this.button6.Location = new System.Drawing.Point(450, 45);
            ...
            this.button3.Location = new System.Drawing.Point(305, 45);
            ...
            this.label1.Location = new System.Drawing.Point(337, 810);
            ...
            this.Name = "sMainframe";
            this.Text = "Model Table Utility";
        ...
        private void Initalcompent()
        {
            ...
            for (int i = 0; i < TotalNum; i++)
            {
                ...
                this.dataGridView[i].EnableHeadersVisualStyles = false;
                this.dataGridView[i].RowHeadersDefaultCellStyle.BackColor = System.Drawing.Color.DarkCyan;//LightSeaGreen;//LightSeaGreen;DarkCyan//FromArgb(((int)(((byte)(192)))), ((int)(((byte)(255)))), ((int)(((byte)(255)))))
                this.dataGridView[i].RowHeadersDefaultCellStyle.ForeColor = System.Drawing.Color.White; //头行 字体颜色
                this.dataGridView[i].RowHeadersDefaultCellStyle.Font = new System.Drawing.Font("宋体", 11F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
        ...
        private void SubData_Grid_View(string [] labl,string [] comboxcontent,int numbe)
        {
        ...
        private void Data_Grid_View(string [] labl,string [] comboxcontent,int numbe)
        {
            ...
            string select = null;
            string select_1d = null;
            string select_2d = null;
            string buffer=null;
           ...
           // System.Data.OleDb.OleDbDataReader thisReader = thisCommand.ExecuteReader();
            ...
            for (i = 0; i < size; i++)
            {
                ...
                {
                    //select = "SELECT " + cfgstruct[gridnum, i].name + " FROM ";
                    select = "SELECT * FROM ";
                    select = select + tabname + "_1d WHERE ";
                    select = select + labl[0] + " = '" + comboxcontent[0] + "'";
                    for (int n_i = 1; n_i < numbe; n_i++)
                    {
                        select = select + " and ";
                        select = select + labl[n_i] + " = '" + comboxcontent[n_i] + "'";
                    }
                    thisCommand.CommandText = select + " ORDER BY IDX1 ASC"; 
                }
                else if (cfgstruct[gridnum, i].dim == "2")
                {
                    select = "SELECT * FROM ";
                    select = select + tabname + "_2d WHERE ";
                    select = select + labl[0] + " = '" + comboxcontent[0] + "'";
                    for (int n_i = 1; n_i < numbe; n_i++)
                    {
                        select = select + " and ";
                ...
                try
                {
                    ...
                    if (cfgstruct[gridnum, i].dim == "0")
                    {
                        ...
                        this.dataGridView[gridnum].Rows[j].ReadOnly = false;
                        ...
                        this.dataGridView[gridnum].Rows[j].Cells[0].Style.Font = new System.Drawing.Font("宋体",12);
                        for (int n_i = 0; n_i < numbe; n_i++)
                        {
                            if (buffer.Trim() == comboxcontent[n_i]&&j<3)
                            {
                                this.dataGridView[gridnum].Rows[j].Cells[0].Style.BackColor = System.Drawing.Color.LightGreen;
                                this.dataGridView[gridnum].Rows[j].Cells[0].ReadOnly = true;
                            }
                        }
                        gridrow = this.dataGridView[gridnum].Rows[j];
                        gridrow.HeaderCell.Value = cfgstruct[gridnum, i].explant;
                        
                        j++;
                      
                    }
                    else if (cfgstruct[gridnum, i].dim == contant.DimIdx1)
                    {
                        ...
                        while (thisReader.Read())
                        {
                            ...
                            if (cfgstruct[gridnum, i].idx1 >= Convert.ToInt32(buffer.Trim()))
                            {
                                ...
                                this.dataGridView[gridnum].Rows[j].DefaultCellStyle = dataGridViewCellStyle;
                                ...
                                this.dataGridView[gridnum].Rows[j + 1].Cells[col_num].Style.Font = new System.Drawing.Font("宋体", 12);
                    ...
                    else if (cfgstruct[gridnum, i].dim == contant.DimIdx2)
                    {
                        num_idx1 = 0;
                        col_num = 2;
                        col_num_id2 = 2;
                        ...
                        while (thisReader.Read())// 读取符合索引要求得所以得行数。如2行  
                        {
                            ...
                            if (SearchEqual(buffer, idx2, num_idx2))
                            {
                                ...
                                this.dataGridView[gridnum].Rows[j + num_idx2].DefaultCellStyle = dataGridViewCellStyle;
                            ...
                            this.dataGridView[gridnum].Rows[j + id2_row].Cells[id2_col].Style.Font = new System.Drawing.Font("宋体", 12);
                        ...
                        this.dataGridView[gridnum].Rows[j + 1].ReadOnly = false;
                        gridrow = this.dataGridView[gridnum].Rows[j + 1];
                        gridrow.HeaderCell.Value = cfgstruct[gridnum, i].explant;
