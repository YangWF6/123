namespace ModelTableUtility
{
    partial class Select_SGP_Table
    {
        ...
        public int number;
        public string[] combstring = new string[10];//选择查询条件
        ...
        private void InitializeComponent()
        {
            ...
            this.button1.Location = new System.Drawing.Point(332, 354);
            ...
            this.Load += new System.EventHandler(this.Select_SGP_Table_Load);
        ...
        private void IntialDialog(int number, string[] lab, string[,] combcontent, int num)   // lab和comb的个数，lab的内容，所有comb的内容，
        {
            ...
            for (int i = 0; i < this.number; i++)
            {
                ...
                this.label[i].Font = new System.Drawing.Font("宋体", 13F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
               ...
               // this.comboBox[i].TabIndex = 1;
                ...
                string temp,t1;
                temp = combcontent[i, 0];
               // this.comboBox[i].SelectedItem = temp;
                if (temp != null)
                {
                    t1 = temp.Trim();
                    this.comboBox[i].Text = t1;// temp;
                    if (gl.TempName[4] == "same_data")
                    {
                        this.comboBox[i].Text = gl.TempName[i];
                        gl.TempName[i] = "unsame_data";
                    }
                }
            }
            this.ResumeLayout(false);
