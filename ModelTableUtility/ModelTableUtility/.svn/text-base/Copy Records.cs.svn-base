...
namespace ModelTableUtility
{
    public partial class Copy_Records : Form
    {
        ...
        {
            int i;
            if ((this.listBox1.Text == "")||(this.listBox2.Text == ""))
            {
            ...
            key_from[0] = this.listBox1.Text;
            key_from[1] = this.listBox3.Text;          
            key_from[2] = this.listBox5.Text;
            ...
            {
                key_to[0,i] = this.listBox2.SelectedItems[i].ToString();
            }
            for (i = 0; i < select1_num; i++)
            {
                key_to[1, i] = this.listBox4.SelectedItems[i].ToString();
            }
            for (i = 0; i < select2_num; i++)
            {
                key_to[2, i] = this.listBox6.SelectedItems[i].ToString();
            }
            ok = true;
            this.Close();
        }
