...
namespace ModelTableUtility
{
    partial class Select_Data_Source
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "Select Model Tables Data Source Name";
            this.Load += new System.EventHandler(this.Select_Data_Source_Load);
        ...
        {
            string select = "SELECT GRADE_NAME  FROM CAGP";//枚举
            ...
            try 
            {
                ...
                {
                    comboBox1.Items.Add(thisReader["GRADE_NAME"].ToString().Trim());
                }
